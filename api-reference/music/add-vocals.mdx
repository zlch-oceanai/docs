...
| `prompt` | string | No | Lyric content or description for the new vocal section. |
| `tags` | string | No | Style tags for the new vocal section. |
...
curl -X POST https://api.example.com/api/v1/music/add-vocals \
  ...
  -d '{
    ...
    "prompt": "Soulful chorus about freedom"
  }'
```
